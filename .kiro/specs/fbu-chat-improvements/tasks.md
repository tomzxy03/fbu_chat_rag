...
- [-] 1. Thêm Bucket4j dependency vào pom.xml
...
- [-] 2. Cập nhật SecurityConfig — mở rộng ADMIN rules cho DocumentController
...
- [-] 4. Tạo DocumentSummaryProjection interface
...
- [-] 5. Tạo DocumentSummaryDto class
...
- [-] 11. Cập nhật index.html — thêm document list section
...
- [ ] 13. Tạo re-ingest script
  - [-] 13.1 Tạo file ai-service/reingest.py
